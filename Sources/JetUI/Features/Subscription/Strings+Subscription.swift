...
public enum SubL {
    ...
    public enum Error {
        ...
        public static var purchaseRecoveryTitle: String {
            localized("subscription.error.purchase_recovery_title")
        }

        public static var purchaseNetworkRecovery: String {
            localized("subscription.error.purchase_network_recovery")
        }

        public static var purchaseStoreRecovery: String {
            localized("subscription.error.purchase_store_recovery")
        }

        public static var purchaseConfigurationRecovery: String {
            localized("subscription.error.purchase_configuration_recovery")
        }

        public static var purchaseGenericRecovery: String {
            localized("subscription.error.purchase_generic_recovery")
        }

        public static var purchasePendingTitle: String {
            localized("subscription.error.purchase_pending_title")
        }

        public static var purchasePendingRecovery: String {
            localized("subscription.error.purchase_pending_recovery")
        }
    }
