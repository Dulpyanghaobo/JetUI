...
public enum AppTheme {
    ...
    public static var spacing: JetSpacing { JetThemeRegistry.theme.layout.spacing }
    
    /// Quick access to radius tokens
    public static var radius: JetRadius { JetThemeRegistry.theme.layout.radius }
    
    /// Quick access to icon tokens
    public static var icons: JetIcons { JetThemeRegistry.theme.layout.icons }
    
    /// Quick access to color tokens
    public static var colors: JetColorPalette { JetThemeRegistry.theme.colors }
    
    /// Quick access to font tokens
    public static var fonts: JetTypography { JetThemeRegistry.theme.fonts }
}
...
public extension View {
    ...
    func jetPadding(_ edges: Edge.Set = .all, _ size: KeyPath<JetSpacing, CGFloat>) -> some View {
        self.padding(edges, JetThemeRegistry.theme.layout.spacing[keyPath: size])
    }
    ...
    func jetPadding(_ size: KeyPath<JetSpacing, CGFloat>) -> some View {
        self.padding(JetThemeRegistry.theme.layout.spacing[keyPath: size])
    }
    ...
    func jetCornerRadius(_ size: KeyPath<JetRadius, CGFloat>) -> some View {
        self.cornerRadius(JetThemeRegistry.theme.layout.radius[keyPath: size])
    }
    ...
    func jetBackground(_ color: Color, radius: KeyPath<JetRadius, CGFloat>) -> some View {
        self.background(
            RoundedRectangle(cornerRadius: JetThemeRegistry.theme.layout.radius[keyPath: radius])
                .fill(color)
        )
    }
    ...
    func jetFrame(
        ...
        let spacing = JetThemeRegistry.theme.layout.spacing
        return self.frame(
...
public extension VStack {
    ...
    init(
        ...
        self.init(
            alignment: alignment,
            spacing: JetThemeRegistry.theme.layout.spacing[keyPath: spacing],
            content: content
        )
    }
}
...
public extension RoundedRectangle {
    ...
    init(radius: KeyPath<JetRadius, CGFloat>) {
        self.init(cornerRadius: JetThemeRegistry.theme.layout.radius[keyPath: radius])
    }
}
...
public struct JetSpacer: View {
    ...
    public init(_ size: KeyPath<JetSpacing, CGFloat>, axis: Axis = .vertical) {
        self.size = JetThemeRegistry.theme.layout.spacing[keyPath: size]
        self.axis = axis
    }
...
public struct JetDivider: View {
    ...
    public init(
        ...
        self.topSpacing = JetThemeRegistry.theme.layout.spacing[keyPath: spacing]
        self.bottomSpacing = JetThemeRegistry.theme.layout.spacing[keyPath: spacing]
        self.color = color
    }
...
public struct JetIconButton: View {
    ...
    public init(
        ...
        self.icon = JetThemeRegistry.theme.layout.icons[keyPath: icon]
        self.size = size
        self.color = color
        self.action = action
    }
